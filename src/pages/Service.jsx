  ...
  return (
    <section className='home-page'>
      <section className="h-dvh w-full bg-black ff-allen grid place-content-center relative overflow-hidden relative">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 text-white text-2xl xs:text-[32px] sm:text-4xl  md:text-6xl xl:text-7xl flex flex-col items-center justify-center gap-4 md:gap-8 z-[1]  backdrop-blur-lg px-9 pt-8 pb-6">
          <p className=''>
            {service?.name}
          </p>
        </div>
        <img src={service?.imgUrl} alt={service?.name} className='h-full w-full absolute object-cover' />
